...
public partial interface ISqlAdapter
{
    ...
    void AppendColumnName(StringBuilder sb, PropertyInfo property);
    /// <summary>
...
static class SqlAdapterHelper
{
    public static string GetColumnName(PropertyInfo property)
    {
        if (SqlMapperExtensions.GetColumnName != null)
        {
            return SqlMapperExtensions.GetColumnName(property);
        }
...
public partial class SqlServerAdapter : ISqlAdapter
{
    ...
    public void AppendColumnName(StringBuilder sb, PropertyInfo columnName)
    {
        sb.AppendFormat("[{0}]", SqlAdapterHelper.GetColumnName(columnName));
    }
    ...
    /// <param name="sb">The string builder  to append to.</param>
    /// <param name="columnName">The column name.</param>
    public void AppendColumnNameEqualsValue(StringBuilder sb, PropertyInfo columnName)
    {
        sb.AppendFormat("[{0}] = @{1}", SqlAdapterHelper.GetColumnName(columnName), columnName);
    }
}
...
public partial class MySqlAdapter : ISqlAdapter
{
    ...
    public void AppendColumnNameEqualsValue(StringBuilder sb, PropertyInfo columnName)
    {
        sb.AppendFormat("`{0}` = @{1}", SqlAdapterHelper.GetColumnName(columnName), columnName.Name);
    }
}
...
public partial class SQLiteAdapter : ISqlAdapter
{
    ...
    /// <param name="sb">The string builder  to append to.</param>
    /// <param name="columnName">The column name.</param>
    public void AppendColumnName(StringBuilder sb, PropertyInfo property)
    {
        sb.AppendFormat("\"{0}\"", SqlAdapterHelper.GetColumnName(property));
    }
    ...
    {
        sb.AppendFormat("\"{0}\" = @{1}", SqlAdapterHelper.GetColumnName(property), property.Name);
    }
}
